...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define :cd, primary: true do |cd|
    cd.vm.network :forwarded_port, host: 8080, guest: 8080, host_ip: "127.0.0.1"
    cd.vm.network :forwarded_port, host: 5000, guest: 5000, host_ip: "127.0.0.1"
    cd.vm.network :forwarded_port, host: 2201, guest: 22, host_ip: "127.0.0.1", id: "ssh", auto_correct: true
  ...
  config.vm.define :prod do |prod|
    prod.vm.network :forwarded_port, host: 2202, guest: 22, host_ip: "127.0.0.1", id: "ssh", auto_correct: true
    prod.vm.network :forwarded_port, host: 9001, guest: 9001, host_ip: "127.0.0.1"
